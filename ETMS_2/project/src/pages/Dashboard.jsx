      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-xs px-3 py-1 bg-sky-100 text-sky-800 rounded-full">
              Last 7 months
            </div>
          </div>
          <div className="h-72">
        ...
        >
          <span className="text-lg font-semibold text-slate-800 mb-6">
            Batch Distribution
          </span>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span
                      className={`inline-block w-3 h-3 rounded-full ${statusColors[item.status]}`}
                    ></span>
                    <div>
